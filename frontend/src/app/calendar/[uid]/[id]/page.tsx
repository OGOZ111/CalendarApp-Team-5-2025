  ...
  const updateCalendar = async (
    ...
    try {
      const response = await fetch(
        `http://localhost:8080calendar/updatecalendar/${uid}/${calendarId}`,
        {
          method: "PUT",
          headers: {
    ...
    <main>
      ...
      <dialog id="alert_modal" className="modal">
        <div className="modal-box">
          <h3
            className={`${fontTitle} font-bold text-2xl flex items-center gap-2`}
          >
            <LuAngry /> Santa says: You are naughty!
          </h3>
          <p className="py-4">
            Please be patient. It&apos;s too early to open this hatch.
          </p>
