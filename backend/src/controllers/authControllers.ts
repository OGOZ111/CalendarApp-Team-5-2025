...
export const deleteUserAndData = async (req: Request, res: Response) => {
  try {
...
export const premiumCheck = (req: Request, res: Response) => {
...
export const protectedCheck = (req: Request, res: Response) => {
  res.status(200).json({ message: "Access granted to protected route" });
};

// Route for generating and storing Christmas images for the user
export const generateImageForUser = async (req: Request, res: Response) => {
  try {
    const { uid } = req.params;
